...
class TestAdapter(data: List<VideoEntity>, private val lifecycle: Lifecycle) :
    BaseMultiItemAdapter<VideoEntity>(data) {

    // 类型 1 的 viewholder
    class ItemVideoVH(val viewBinding: ActivityYoutubeListItemBinding) : RecyclerView.ViewHolder(viewBinding.root){
    }
            ...
            object : OnMultiItemAdapterListener<VideoEntity, ItemVideoVH> { // 类型 1
                override fun onCreate(
                    ...
                    val viewBinding = DataBindingUtil.inflate<ActivityYoutubeListItemBinding>(
                        ...
                        R.layout.activity_youtube_list_item, parent, false
                    )
                ...
                override fun onBind(holder: ItemVideoVH, position: Int, item: VideoEntity?) {
                    ...
                    holder.viewBinding.youtubePlayerView.addYouTubePlayerListener(object :
