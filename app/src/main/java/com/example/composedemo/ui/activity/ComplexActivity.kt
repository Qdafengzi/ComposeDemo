...
import com.example.composedemo.flinger.bahaviours.StockFlingBehaviours

/**
 * 添加了flingBehavior 纵享丝滑
 */
...
//            flingBehavior = flingBehavior(scrollConfiguration = ScrollState.buildScrollBehaviour()),
            content = {
                //头部内容
                item {
                    Box(
