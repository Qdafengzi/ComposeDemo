...
class AppColors(
    ...
    var placeholder: Color by mutableStateOf(placeholder)
        private set
    var toolbarColor: Color by mutableStateOf(toolbarColor)
        private set
...
fun AppTheme(
    ...
    val toolbar = animateColorAsState(targetColors.toolbarColor, TweenSpec(600))
